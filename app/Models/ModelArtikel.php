...
class ModelArtikel extends Model
{
    ...
    // DataTables
    protected $column_order = ['id', 'judul_artikel', 'isi_artikel', 'thumbnail_artikel', 'tag_artikel', 'kategori_artikel'];
    protected $column_search = ['judul_artikel', 'isi_artikel', 'tag_artikel', 'kategori_artikel'];
